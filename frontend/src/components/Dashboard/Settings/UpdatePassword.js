            ...
            <div className='my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12'>
                ...
                <div className='flex flex-col gap-y-2'>
                    <div className='flex flex-col gap-y-2 relative'>
                        <label htmlFor='currentPassword' className='mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5'>Current Password</label>
                        <input
                        ...
                        />
                        <div className='absolute right-3 top-[45px] z-[10] cursor-pointer' onClick={()=>setShowPassword((prev)=>!prev)}>
                        {
                            showPassword ? 
                    ...
                    <div className='flex flex-col gap-y-2 relative'>
                        <label htmlFor='newPassword' className='mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5'>New Password</label>
                        <input
                            className='form-style'
                        ...
                        />
                        <div className='absolute right-3 top-[45px] z-[10] cursor-pointer' onClick={()=>setShowNewPassword((prev)=>!prev)}>
                        {
                            showNewPassword ? 
                            (<AiOutlineEyeInvisible fontSize={24} fill="#AFB2BF"/>) : 
                            (<AiOutlineEye fontSize={24} fill="#AFB2BF"/>)
