...
const CartTable = () => {
  ...
  return (
    <div className="flex flex-col gap-y-4 justify-center m-4 text-center">
      {cart.length === 0 ? (
        <p className="text-white text-xl font-bold">No courses in Cart!</p>
      ) : (
        <table className="border-2 border-richblack-400 w-full">
          <tbody>
            <tr>
              <td className="text-white text-center w-[60%]">Course</td>
              <td className="text-white text-center">Price</td>
              <td className="text-white text-center">Actions</td>
            </tr>
            {cart.map((course) => {
              return (
            ...
            <tr>
              <td></td>
              <td className="text-center text-richblack-5 p-2">Total Price</td>
